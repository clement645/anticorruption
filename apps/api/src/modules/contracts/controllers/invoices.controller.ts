...
export class InvoicesController {
  ...
  get(@Param('id') id: string) {
    return this.invoicesService.getView(id);
  }

  @Post(':id/verify')
  @HttpCode(HttpStatus.OK)
  @RequirePermissions('invoice:verify')
  verify(
    @Param('id') id: string,
    @CurrentUser() actor: AuthenticatedUser,
    @Req() req: Request,
  ) {
    return this.invoicesService.verify(id, actor, meta(req));
  }
  ...
  reject(
    ...
    return this.invoicesService.reject(id, dto, actor, meta(req));
  }
}
